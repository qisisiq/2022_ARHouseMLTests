...
namespace MagicLeap.Examples
{
    ...
    public class MLWebRTCExample : MonoBehaviour
    {
        ...
        private void CreateLocalMediaStream()
        {
            ...
            if (useHWBuffers)
                streamCapabilities = MLCamera.GetImageStreamCapabilitiesForCamera(mlCamera, MLCamera.CaptureType.Video, MLCamera.CaptureType.Preview);
            else
                streamCapabilities = MLCamera.GetImageStreamCapabilitiesForCamera(mlCamera, MLCamera.CaptureType.Video);
